...
// 'script.cpp' HAS BEEN EXTREMELY HEAVILY MODIFIED FROM THE ORIGINAL SDK, 'script.h' HAS ALSO BEEN MODIFIED, I USED THIS VISUAL STUDIO SOLUTION AS A TEMPLATE TO BUILD OFF OF. THE SUPPORTING FILES FOR
